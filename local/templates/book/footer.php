        ...
        <div class="footer__inner">
            ...
            <div class="footer__info">
                ...
                <div class="footer__contact">
                    ...
                    <div>671920, РЕСПУБЛИКА БУРЯТИЯ,<br> ДЖИДИНСКИЙ РАЙОН,<br> С. ПЕТРОПАВЛОВКА,<br> УЛ. ТЕРЕШКОВОЙ, 7"Б"</div>
                <br>
                    <div>ТЕЛЕФОНЫ</div>
                    <div><a href="tel:83013441663">8(30134)41-6-63</a></div>
                    <div><a href="tel:83013411693">8(30134)41-7-93</a></div>
                <br>
                    <div>EMAIL:</div>
                    <div><a href="cbdzd@bk.ru">cbdzd@bk.ru</a></div>
                </div>
        </div>
    </div>
